(* C2PP
  ...
  ***************************************************************************
  File last update : 2025-06-28T20:48:24.000+02:00
  Signature : 49fc33b311a9579b00b35b48d9b169cfc9abae10
  ***************************************************************************
*)
...
const
  ...
  /// </summary>
  CAboutURL = 'https://shiftkeysgenerator.olfsoftware.fr/';
  ...
  /// </summary>
  CSoftwareBuyURL =
    'https://store.olfsoftware.fr/en/developer-software-c-3/shift-keys-generator-p-26';
  ...
  /// </remarks>
  CProjectFolderName = 'ShiftKeysGenerator';
